 ...
 * @author 0zzx0
 * @brief 定义一些自定义的CUDA操作，主要是预处理部分和后处理部分的加速
 * @version 1.0
 * @date 2023-6-11
 *
...
static __global__ void resize_bilinear_and_normalize_kernel(uint8_t* src, int src_line_size,
                                                            int src_width, int src_height,
                                                            float* dst, int dst_width,
                                                            int dst_height, float sx, float sy,
                                                            Norm norm, int edge);
